...
import dev.comunidad.net.model.server.impl.AquaCoreServerData;
import dev.comunidad.net.model.server.impl.DefaultServerData;
import dev.comunidad.net.model.server.impl.HeliumServerData;
